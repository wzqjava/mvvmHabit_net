package com.bawei.myapplication2.ui.network;
...
public class NetWorkViewModel extends BaseViewModel<DemoRepository> {
    ...
    public ItemBinding<NetWorkItemViewModel> itemBinding = ItemBinding.of(com.bawei.myapplication2.BR.viewModel, R.layout.item_network);
